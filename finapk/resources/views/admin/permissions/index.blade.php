<x-admin-layout>
    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">Permissions Manager
                    ...
                    <table class="w-full mx-auto table-auto">
                        <thead class="justify-between">
                            <tr class="bg-slate-900">
                                ...
                                <th class="px-16 py-2 text-left">
                                    <span class="text-yellow-400 font-semibold">Permissions</span>
                                </th>
                        ...
                        <tbody class="bg-slate-600 text-gray-200">
                            <tr class="bg-slate-600 border-b-2 border-gray-500">
                                <td class="px-16 py-2 flex flex-row items-center">
                                    ...
                                    <div>
                                        <h5 class="text-left ml-6 font-semibold">John Doe</h5>
                                        <h6 class="text-left ml-6 font-semibold text-gray-400">john@email.com</h6>
                                    </div>
                                </td>
                                <td class="px-16 py-2 font-semibold">
                                    <span class="text-left font-semibold">Firts Officer</span>
                                </td>
                            ...
                            <tr class="bg-slate-600 border-b-2 border-gray-500">
                                ...
                                <td class="px-16 py-2 font-semibold">
                                    <span class="text-left font-semibold">Customer Service</span>
                                </td>
                            ...
                            <tr class="bg-slate-600 border-b-2 border-gray-500">
                                <td class="px-16 py-2 flex flex-row items-center">
                                    <img class="h-8 w-8 rounded-full object-cover "
                                        src="https://randomuser.me/api/portraits/men/21.jpg" alt="" />
                                    <div>
                                        <h5 class="text-left ml-6 font-semibold">John Doe</h5>
                                        <h6 class="text-left ml-6 font-semibold text-gray-400">john@email.com</h6>
                                    </div>
                                ...
                                <td class="px-16 py-2 font-semibold">
                                    <span class="text-left font-semibold">Copy Writer</span>
                                </td>
