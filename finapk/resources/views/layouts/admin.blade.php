    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-4 pt-8 pb-6">
                <a href="#"
                    class="text-2xl font-bold tracking-widest text-teal-400 hover:text-teal-200 uppercase rounded-lg focus:outline-none focus:shadow-outline">
                    <span>Finaciële APK</span>
                    <span
                        class="text-lg font-semibold tracking-widest text-teal-400  uppercase rounded-lg focus:outline-none focus:shadow-outline">
                        Admin</span>
                </a>
                        ...
                        <a class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto">
                            ...
                            <div @click.away="open = false" class="relative" x-data="{ open: false }">
                                ...
                                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                    ...
                                    <div class="px-2 py-2 bg-white rounded-md shadow bg-slate-700">
