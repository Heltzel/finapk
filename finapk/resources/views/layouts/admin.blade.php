        ...
        <div @click.away="open = false"
            ...
            <nav :class="{ 'block': open, 'hidden': !open }"
                ...
                <x-adminpanel.nav.dropdown id="2" title="Roles and Permissions">
                    <x-adminpanel.nav.button title="Roles Manager" href="{{ route('admin.roles.index') }}" />
                    <x-adminpanel.nav.button title="Permissions Manager"
                        href="{{ route('admin.permissions.index') }}" />
                </x-adminpanel.nav.dropdown>
                {{-- <x-adminpanel.nav.button title="User Management" href="#" /> --}}
